    ...
    return (
        <>
            ...
            <div className="w-10/12 mx-auto my-3">
                ...
                <h4 className="text-white font-medium text-[32px] mb-5 md:text-[28px] leading-8">
                    ...
                    <div role="tablist" className="flex flex-col pb-4 md:flex-row justify-between text-white gap-2">
                        {(Object.keys(sectionComponents) as SectionId[]).map((id) => (
                            <button
                                ...
                                className="border rounded-xl p-2 w-full transition-colors aria-selected:bg-amber-700 aria-selected:border-gray-50 aria-selected:font-bold"
                            >
